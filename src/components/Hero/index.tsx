            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight dark:text-white">
                  Platform Pembelajaran Personal dengan Kecerdasan Buatan
                </h1>
                <p className="text-body-color dark:text-body-color-dark mb-12 text-base leading-relaxed! sm:text-lg md:text-xl">
                  EduCraft AI membantu pelajar dan profesional mencapai tujuan belajar mereka dengan sistem yang adaptif dan cerdas. AI kami menyesuaikan kursus, kuis, dan rencana belajar berdasarkan gaya belajar dan perkembangan unik Anda.
                </p>
